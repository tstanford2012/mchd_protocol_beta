...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: CardiacAdultALSScreen(),
    ),
  ));
}

class CardiacAdultALSScreen extends StatelessWidget {
  @override
...
class CardiacLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _cardiacListView(context);
  }
}

Widget _cardiacListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

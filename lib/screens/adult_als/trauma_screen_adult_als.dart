...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: TraumaAdultALSScreen(),
    ),
  ));
}

class TraumaAdultALSScreen extends StatelessWidget {
  @override
...
class TraumaLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _traumaListView(context);
  }
}

Widget _traumaListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

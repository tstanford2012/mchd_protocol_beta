...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: ObstetricalAdultALSScreen(),
    ),
  ));
}

class ObstetricalAdultALSScreen extends StatelessWidget {
  @override
...
class ObstetricalLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _obstetricalListView(context);
  }
}

Widget _obstetricalListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: MedicalAdultALSScreen(),
    ),
  ));
}

class MedicalAdultALSScreen extends StatelessWidget {
  @override
...
class MedicalLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _medicalListView(context);
  }
}

Widget _medicalListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

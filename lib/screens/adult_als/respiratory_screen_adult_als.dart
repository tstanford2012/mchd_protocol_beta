...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: RespiratoryAdultALSScreen(),
    ),
  ));
}

class RespiratoryAdultALSScreen extends StatelessWidget {
  @override
...
class RespiratoryLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _respiratoryListView(context);
  }
}

Widget _respiratoryListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

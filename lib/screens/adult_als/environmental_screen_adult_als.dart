...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: EnvironmentalAdultALSScreen(),
    ),
  ));
}

class EnvironmentalAdultALSScreen extends StatelessWidget {
  @override
...
class EnvironmentalLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _environmentalListView(context);
  }
}

Widget _environmentalListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

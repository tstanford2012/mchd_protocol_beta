...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: FormsIntroScreen(),
    ),
  ));
}

class FormsIntroScreen extends StatelessWidget {
  @override
...
class FormsIntroLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _formsIntroListView(context);
  }
}

Widget _formsIntroListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

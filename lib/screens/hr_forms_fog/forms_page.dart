...
class FormsFScreen extends StatelessWidget {
  @override
...
class FormsFLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _formsFListView(context);
  }
}

Widget _formsFListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: FormsFieldVehicleScreen(),
    ),
  ));
}

class FormsFieldVehicleScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: MaterialApp(
        ...
        title: 'Forms Field FOG Vehicle Screen',
        home: Scaffold(
          appBar: AppBar(
...
class FormsFieldVehicleLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _formsFieldVehicleListView(context);
  }
}

Widget _formsFieldVehicleListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

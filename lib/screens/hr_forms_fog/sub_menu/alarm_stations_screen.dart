...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: FormsAlarmStationssScreen(),
    ),
  ));
}

class FormsAlarmStationssScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: MaterialApp(
        ...
        title: 'Forms Alarm Stationss Screen',
        home: Scaffold(
          appBar: AppBar(
          ...
          body: FormsAlarmStationssLayout(),
        ),
      ),
    );
  }
...
class FormsAlarmStationssLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _formsAlarmStationssListView(context);
  }
}

Widget _formsAlarmStationssListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

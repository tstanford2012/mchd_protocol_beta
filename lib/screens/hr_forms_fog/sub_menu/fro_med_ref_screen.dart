...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: FormsFROMedRefScreen(),
    ),
  ));
}

class FormsFROMedRefScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: MaterialApp(
        ...
        title: 'Forms FRO Med Ref Screen',
        home: Scaffold(
          appBar: AppBar(
...
class FormsFROMedRefLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _formsFROMedRefListView(context);
  }
}

Widget _formsFROMedRefListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

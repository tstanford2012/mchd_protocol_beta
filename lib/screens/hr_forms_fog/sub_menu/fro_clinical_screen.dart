...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: FormsFROClinicalScreen(),
    ),
  ));
}

class FormsFROClinicalScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: MaterialApp(
        ...
        title: 'Forms FRO Clinical Screen',
        home: Scaffold(
          appBar: AppBar(
...
class FormsFROClinicalLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _formsFROClinicalListView(context);
  }
}

Widget _formsFROClinicalListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

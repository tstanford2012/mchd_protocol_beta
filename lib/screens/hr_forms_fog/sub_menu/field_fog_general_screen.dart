...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: FormsFieldGeneralScreen(),
    ),
  ));
}

class FormsFieldGeneralScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: MaterialApp(
        ...
        title: 'Forms Field FOG General Screen',
        home: Scaffold(
          appBar: AppBar(
...
class FormsFieldGeneralLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _formsFieldGeneralListView(context);
  }
}

Widget _formsFieldGeneralListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

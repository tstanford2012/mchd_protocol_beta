...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: CardiacPediBLSScreen(),
    ),
  ));
}

class CardiacPediBLSScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: MaterialApp(
        ...
        title: 'Cardiac Pedi BLS protocol',
        home: Scaffold(
          appBar: AppBar(
...
class CardiacPediBLSLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _cardiacPediBLSListView(context);
  }
}

Widget _cardiacPediBLSListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

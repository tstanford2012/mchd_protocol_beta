...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: TraumaPediBLSScreen(),
    ),
  ));
}

class TraumaPediBLSScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: MaterialApp(
        ...
        title: 'Trauma Pedi BLS protocol',
        home: Scaffold(
          appBar: AppBar(
...
class TraumaPediBLSLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _traumaPediBLSListView(context);
  }
}

Widget _traumaPediBLSListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

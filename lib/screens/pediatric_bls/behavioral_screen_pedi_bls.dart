...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: BehavioralPediBLSScreen(),
    ),
  ));
}

class BehavioralPediBLSScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: MaterialApp(
        ...
        title: 'Behavioral Pedi BLS protocol',
        home: Scaffold(
          appBar: AppBar(
...
class BehavioralPediBLSLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _behavioralPediBLSListView(context);
  }
}

Widget _behavioralPediBLSListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

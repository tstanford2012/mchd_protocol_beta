...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: MedicalPediALSScreen(),
    ),
  ));
}

class MedicalPediALSScreen extends StatelessWidget {
  @override
...
class MedicalPediALSLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _medicalPediALSListView(context);
  }
}

Widget _medicalPediALSListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: BehavioralPediALSScreen(),
    ),
  ));
}

class BehavioralPediALSScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: MaterialApp(
        ...
        title: 'Behavioral Pedi protocol',
        home: Scaffold(
          appBar: AppBar(
...
class BehavioralPediALSLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _behavioralPediALSListView(context);
  }
}

Widget _behavioralPediALSListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

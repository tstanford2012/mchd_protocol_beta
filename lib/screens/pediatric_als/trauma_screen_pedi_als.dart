...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: TraumaPediALSScreen(),
    ),
  ));
}

class TraumaPediALSScreen extends StatelessWidget {
  @override
...
class TraumaPediALSLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _traumaPediALSListView(context);
  }
}

Widget _traumaPediALSListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(

...
void main() {
  runApp(WillPopScope(
    ...
    child: MaterialApp(
      title: 'Flutter',
      home: CardiacArrestAdultBLSScreen(),
    ),
  ));
}

class CardiacArrestAdultBLSScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: MaterialApp(
        ...
        title: 'BLS Adult Cardiac Arrest protocol',
        home: Scaffold(
          appBar: AppBar(
...
class BLSCardiacArrestLayout extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return _cardiacArrestBLSListView(context);
  }
}

Widget _cardiacArrestBLSListView(BuildContext context) {
  return ListView(
    children: <Widget>[
      Card(
